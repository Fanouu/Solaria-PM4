...
class SaphirHelmet extends Armor {
    
    public function __construct(){
        parent::__construct(new ItemIdentifier(ItemIds::GOLD_HELMET, 0), "Saphir Helmet", new ArmorTypeInfo(3, 663, ArmorInventory::SLOT_HEAD));
    }
