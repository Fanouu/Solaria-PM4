...
class SaphirLeggings extends Armor {
    
    public function __construct(){
        parent::__construct(new ItemIdentifier(ItemIds::GOLD_LEGGINGS, 0), "Saphir Leggings", new ArmorTypeInfo(6, 795, ArmorInventory::SLOT_LEGS));
    }
