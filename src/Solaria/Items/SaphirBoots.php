...
class SaphirBoots extends Armor {
    
    public function __construct(){
        parent::__construct(new ItemIdentifier(ItemIds::GOLD_BOOTS, 0), "Saphir Boots", new ArmorTypeInfo(3, 729, ArmorInventory::SLOT_FEET));
    }
