...
class SaphirChestplate extends Armor {
    
    public function __construct(){
        parent::__construct(new ItemIdentifier(ItemIds::GOLD_CHESTPLATE, 0), "Saphir Chesplate", new ArmorTypeInfo(8, 828, ArmorInventory::SLOT_CHEST));
    }
